...
class NLCModel(object):
    def __init__(self, src_vocab_size, tgt_vocab_size, size, num_layers, max_gradient_norm, batch_size, learning_rate,
        ...
        with tf.variable_scope("NLC", initializer=tf.uniform_unit_scaling_initializer(1.0, seed=self.FLAGS.seed)):
